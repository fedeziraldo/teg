...
db.paises.insert([
  {
    ...
    posX: 27,
    posY: 49,
    continente: ObjectId("1234567890123456789012c3"),
    escudo: ObjectId("1234567890123456789012e5"),
  },
  {
    id: 2,
    nombre: 'Albania',
    ...
    posX: 1046,
    posY: 428,
    continente: ObjectId("1234567890123456789012c6"),
    escudo: ObjectId("1234567890123456789012e5"),
  },
  {
    id: 3,
  ...
  },
  {
    ...
    posX: 976,
    posY: 809,
    continente: ObjectId("1234567890123456789012c1"),
    escudo: ObjectId("1234567890123456789012e5"),
  },
  {
    id: 5,
    ...
    posX: 1129,
    posY: 628,
    continente: ObjectId("1234567890123456789012c5"),
    escudo: ObjectId("1234567890123456789012e5"),
  },
  {
    id: 6,
    ...
    posX: 293,
    posY: 954,
    continente: ObjectId("1234567890123456789012c4"),
    escudo: ObjectId("1234567890123456789012e5"),
  },

  {
    ...
    posX: 1224,
    posY: 837,
    continente: ObjectId("1234567890123456789012c7"),
    escudo: ObjectId("1234567890123456789012e5"),
  },
  {
    id: 8,
  ...
  },
  {
    ...
    posX: 321,
    posY: 480,
    continente: ObjectId("1234567890123456789012c2"),
    escudo: ObjectId("1234567890123456789012e5"),
  },
  {
    id: 17,
...
db.continentes.insert([
  {
    _id: ObjectId("1234567890123456789012c1"),
		id: 1,
    nombre: "Africa",
    fichas: 4,
    escudo: ObjectId("1234567890123456789012e7"),
  },
  {
    _id: ObjectId("1234567890123456789012c2"),
		id: 2,
    nombre: "America Central",
    fichas: 3,
    escudo: ObjectId("1234567890123456789012e1"),
  },
  {
    _id: ObjectId("1234567890123456789012c3"),
		id: 3,
  ...
  {
    _id: ObjectId("1234567890123456789012c4"),
		id: 4,
    nombre: "America del Sur",
    fichas: 4,
    escudo: ObjectId("1234567890123456789012e6"),
  },
  {
    _id: ObjectId("1234567890123456789012c5"),
		id: 5,
    nombre: "Asia",
    fichas: 8,
    escudo: ObjectId("1234567890123456789012e5"),
  ...
  {
    _id: ObjectId("1234567890123456789012c6"),
		id: 6,
    nombre: "Europa",
    fichas: 8,
    escudo: ObjectId("1234567890123456789012e5"),
  ...
  {
    _id: ObjectId("1234567890123456789012c7"),
		id: 7,
    nombre: "Oceania",
    fichas: 3,
    escudo: ObjectId("1234567890123456789012e2"),
  },
])
